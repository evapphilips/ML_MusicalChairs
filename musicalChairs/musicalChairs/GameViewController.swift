...
//            self.startMultipeerService(displayName: name)
    ...
    @IBAction func buttonsTapped(_ sender: UIButton){
        ...
        buttons[index].layer.backgroundColor = UIColor.red.cgColor
        ...
        multipeerService?.send(msg: "\(index)")
//        multipeerService?.send(msg: playerName!)

//        switch index {
//        case 0:
//            sender.layer.backgroundColor = UIColor.red.cgColor
//            sender.setTitle(playerName, for: .normal)
...
//        }
    ...
    func receivedMsg(manager: MultipeerService, msg: String) {
        DispatchQueue.main.async {
            if let i = Int(msg) {
//                self.buttons[i].setTitle(self.playerName, for: .normal)
                self.buttons[i].layer.backgroundColor = UIColor.red.cgColor
